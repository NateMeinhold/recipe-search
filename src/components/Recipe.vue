...
export default {
  ...
  methods: {
    ...
    findRecipe: function() {
      ...
      //got rid of this: let proxyUrl = 'https://cors-anywhere.herokuapp.com/' 1/11/24
      // axios.get('https://www.themealdb.com/api/json/v1/1/filter.php', {
      //and proxyUrl + in the axios git bracket and it seems to work 1/11/24
      axios
